package ch.sourcemotion.vertx.kotlin.eventbus.browser.json

import ch.sourcemotion.vertx.kotlin.eventbus.browser.codec.json.JsonEventBusCodec
...
class JsonEventBusCodecTest {

    @BeforeTest
    fun registerCodecs() {
        JsonEventBusCodec.register(Dto.serializer())
    }
